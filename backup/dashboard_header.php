<!-- Top line begins -->
<div id="top">
  <div class="wrapper"> <a href="index.php" title="" class="logo"><img src="images/DeckBattle_Inverted_small.png" alt="" /></a> 
    
    <!-- Right top nav -->
    <div class="topNav">
      <ul class="userNav">
        <!-- <li><a title="" class="search"></a></li> -->
        <li><a href="profile.php" title="My Profile" class="profile tipN"></a></li>
        <li><a href="settings.php" title="Settings" class="settings tipN"></a></li>
        <li><a href="login.php?logout=true" title="Logout" class="logout tipN"></a></li>
