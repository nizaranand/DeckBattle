$(function() {
	...
	$('.deck').dataTable({
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "/dashboard/services/getcards_deck.php?deckid="+deckid, //and userid // TO DO Check if user cannot access deck.
		...
		$('td:eq(8)', nRow).html(createTableToolbarDeck);
	...
	$('.sideboard').dataTable({
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "/dashboard/services/getcards_sideboard.php?deckid="+deckid,
		"fnCreatedRow": function( nRow, aData, iDataIndex ) {
