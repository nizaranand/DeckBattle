$(function() {
	...
	$('.collection').dataTable({
		...
		$('td:eq(0)', nRow).html('<div id="normal_' + aData[8] + '" style="display: inline;margin-right:5px;font-weight:bold;">'+aData[0] +'</div><div class="btn-group"><a href="#" class="tablectrl_small bDefault" onclick="addcardstocollection(' + aData[8] + ',\'' + aData[2] + '\',1,0,0,0,0)"><span class="iconb tipS" title="Add one Normal" data-icon="&#xe099;"></span></a><a href="#" class="tablectrl_small bDefault" onclick="addcardstocollection(' + aData[8] + ',\'' + aData[2] + '\',-1,0,0,0,0)"><span class="iconb tipS" title="Remove one Normal" data-icon="&#xe098;"></span></a></div>');
		$('td:eq(1)', nRow).html('<div id="foil_' + aData[8] + '" style="display:inline;margin-right:5px;font-weight:bold;">'+aData[1] +'</div><div class="btn-group"><a href="#" class="tablectrl_small bDefault" onclick="addcardstocollection(' + aData[8] + ',\'' + aData[2] + '\',0,1,0,0,0)"><span class="iconb tipS" title="Add one Foil" data-icon="&#xe099;"></span></a><a href="#" class="tablectrl_small bDefault" onclick="addcardstocollection(' + aData[8] + ',\'' + aData[2] + '\',0,-1,0,0,0)"><span class="iconb tipS" title="Remove one Foil" data-icon="&#xe098;"></span></a></div>');
