$(function() {
	...
	$('.collection').dataTable({
		...
		$('td:eq(8)', nRow).html('<div class="btn-group"><a href="#" class="tablectrl_small bDefault" onclick="addcardstotradelist('+ aData[0] +',\''+ aData[1] +'\',1,0)"><span class="iconb tipS" title="Add one Normal" data-icon="&#xe14a;"></span></a></div><div class="btn-group"><a href="#" class="tablectrl_small bDefault" onclick="addcardstotradelist('+ aData[0] +',\''+ aData[1] +'\',0,1)"><span class="iconb tipS" title="Add one Foil" data-icon="&#xe14b;"></span></a></div><div class="btn-group"><a href="#" class="tablectrl_small bDefault" onclick="addcardstotradelist('+ aData[0] +',\''+ aData[1] +'\',-1,0)"><span class="iconb tipS" title="Remove one Normal" data-icon="&#xe14a;"></span></a></div><div class="btn-group"><a href="#" class="tablectrl_small bDefault" onclick="addcardstotradelist('+ aData[0] +',\''+ aData[1] +'\',0,-1)"><span class="iconb tipS" title="Remove one Foil" data-icon="&#xe14b;"></span></a></div></div>')
