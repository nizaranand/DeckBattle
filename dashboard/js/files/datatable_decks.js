$(function() {
	...
	$('.deck').dataTable({
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "/dashboard/getcarddatadeck.php?deckid="+deckid, //and userid // TO DO Check if user cannot access deck.
	...
	$('.sideboard').dataTable({
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "/dashboard/getcarddatadeck.php?deckid="+deckid,
		"fnCreatedRow": function( nRow, aData, iDataIndex ) {
