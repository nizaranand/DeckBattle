...
if (isset($_FILES['ImageFile'])) {
	...
	// Tmp name of image file stored in PHP tmp folder
	$ImageType = $_FILES['ImageFile']['type'];
	//Obtain file type, returns "image/png", image/jpeg, text/plain etc.
	...
	if (resizeImage($CurWidth, $CurHeight, $BigImageMaxSize, $DestRandImageName, $CreatedImage, $Quality, $ImageType)) {
		...
		// echo '<tr>';
		// echo '<td align="center"><img src="/avatars/'.$ThumbPrefix.$NewImageName.'" alt="Thumbnail"></td>';
		//echo '</tr><tr>';
		//echo '<td align="center"><img src="/avatars/'.$NewImageName.'" alt="Resized Image"></td>';
		//echo '</tr>';
		//echo '</table>';
		$userid = $_SESSION['user_id'];
		$dbthumb = $ThumbPrefix . $NewImageName;
		if ($update_stmt = $mysqli -> prepare("UPDATE members SET avatar = ? , avatarlarge = ? WHERE id = ?;")) {
			$update_stmt -> bind_param('sss', $dbthumb, $NewImageName, $userid);
			$update_stmt -> execute();
			$_SESSION['avatar'] = $ThumbPrefix . $NewImageName;
		}
