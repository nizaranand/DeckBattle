			...
			<div id="tab-container" class="tab-container">
				...
				<div id="general">
					<div id="">
						<ul class="subNav">
							<li>
								<a href="/dashboard/collection/collection.php" title=""><span class="icos-images2"></span>Card Collection</a>
							</li>
							<li>
								<a href="/dashboard/collection/decks.php" title=""><span class="icos-fullscreen"></span>Deck Collection</a>
							</li>
							<li>
								<a href="/dashboard/collection/favorites.php" title=""><span class="icos-coverflow"></span>Favorite Cards</a>
							</li>
							<li>
								<a href="/dashboard/collection/tradelist.php" title=""><span class="icos-view"></span>Trade List</a>
							</li>
							<li>
								<a href="/dashboard/collection/wishlist.php" title=""><span class="icos-beta"></span>Wish List</a>
							</li>
						</ul>
					</div>
					<div class="divider">
