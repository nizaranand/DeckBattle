...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/dashboard/js/files/datatable_favorites.js"></script>
 ...
 ?>
		...
		<div id="content">
			...
			createPageHeader("Favorite Cards", $mysqli);
			?>
			<?php
				include 'dashboard/include/dashboard_breadcrumb.php';
				generateBreadcrumb("Dashboard", "Cards & Decks", "Favorite Cards");
			?>
			<!-- Main content -->
			<div class="wrapper">
				<div class="wButton grid6">
					<a class="buttonL bGreen" style="margin-top: 10px;" title="" href="/dashboard/collection/add_cards_collection-wishlist-favorites.php?from=fav">Add cards to Favorites</a>
				</div>
				<div class="widget">
					<div class="whead">
						<h6>Favorite Cards</h6>
						<div class="clear"></div>
					</div>
					<div class="shownpars" >
						<table cellpadding="0" cellspacing="0" border="0" class="favorites">
							<thead>
								<tr>
									<th>ID</th>
									<th>Name</th>
