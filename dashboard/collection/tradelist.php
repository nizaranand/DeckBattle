...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 ?>
		...
		<div id="content">
			...
			createPageHeader("Trading List", $mysqli);
			?>
			<?php
				include 'dashboard/include/dashboard_breadcrumb.php';
				generateBreadcrumb("Dashboard", "Cards & Decks", "Trading List");
			?>
			<!-- Main content -->
			<div class="wrapper">
				<div class="wButton grid6">
					<a class="buttonL bGreen" style="margin-top: 10px;" title="" href="/dashboard/collection/add_cards_tradelist.php">Add cards to Tradelist</a>
				</div>
				<div class="widget">
					<div class="whead">
						<h6>Trade List</h6>
