...
<!-- Content begins -->
<div id="content">
  <?php include 'dashboard/include/dashboard_pageheader.php'; createPageHeader("Collection",$mysqli);?>
  <?php include 'dashboard/include/dashboard_breadcrumb.php'; generateBreadcrumb("Dashboard","Cards & Decks","Card Collection");?>
  <!-- Main content -->
  <div class="wrapper">
    <div class="wButton grid6"> <a class="buttonL bGreen" style="margin-top: 10px;" title="" href="/dashboard/collection/add_cards_collection-wishlist-favorites.php?from=col">Add cards to Collection</a> </div>
    <div class="widget">
      <div class="whead">
