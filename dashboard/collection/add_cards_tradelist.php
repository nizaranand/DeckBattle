...
<!-- Content begins -->
<div id="content">
  <?php include 'dashboard/include/dashboard_pageheader.php'; createPageHeader("Add Cards from your Collection to your Tradelist",$mysqli);?>
  <?php include 'dashboard/include/dashboard_breadcrumb.php'; generateBreadcrumb("Dashboard","Cards & Decks","Add Cards to Tradelist"); ?>
  <!-- Main content -->
  <div class="wrapper">
    <div class="wButton grid6"> <a class="buttonL bBlue" style="margin-top: 10px;" title="" href="tradelist.php">Back to Tradelist</a> </div>
    <div class="widget">
      <div class="whead">
        <h6>Card Database</h6>
        <div class="clear"></div>
