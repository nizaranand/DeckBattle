...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="/dashboard/js/files/datatable_addtofavorites.js"></script>
...
userid: '<?php echo $_SESSION['user_id']; ?>',
	...
	<body>
		...
		<div id="content">
            ...
            createPageHeader("Add Cards To Favorite Card Collection", $mysqli);
			?>
			<?php
            require_once 'dashboard/include/dashboard_breadcrumb.php';
            generateBreadcrumb("Dashboard", "Cards & Decks", "Add Cards To Favorite Card Collection");
			?>

			<!-- Main content -->
			<div class="wrapper">
				<div class="wButton grid6">
					<a class="buttonL bBlue" style="margin-top: 10px;" title="" href="favorites.php">Back to Favorites Card Collection</a>
               	</div>
				<div class="widget">
					<div class="whead">
						<h6>Card Database</h6>
