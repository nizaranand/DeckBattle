...
<div>
<h3><span class="colored">///</span> <?php comments_number('There are no comments yet, but you can be the first','1 Comment:','% Comments:')?></h3>
...
<div id="respond">
<h3><span class="colored">///</span> <?php comment_form_title( 'Leave a Reply', 'Leave a Reply to %s' ); ?></h3>
...
<?php else : ?>
    ...
    <input  class="span4" placeholder="E-mail" name="email" value="<?php echo esc_attr($comment_author_email); ?>" />
<?php endif; ?>
    <textarea type="text" placeholder="Message" id="comment" name="comment" rows="5" class="span8"></textarea>
	<button name="submit" id="submit_form" type="submit"  class="mybutton">Post comment</button>
