...
if ( function_exists('register_sidebar') )
    register_sidebar(array(
        ...
        'after_widget' => '</div>',
        'before_title' => '<h4><span class="colored">///</span> ',
        'after_title' => '</h4> <hr>',
    ));
...
function wp_corenavi() {
  ...
  if ($max > 1) echo '<ul class="pager" style="float:left;">';
...
?>
    ...
    <h4>Project icon</h4>
    <p>
		<input type="text" name="extra[port-icon]" style="width:100%;" value="<?php echo get_post_meta($post->ID, 'port-icon', 1); ?>">  </input>
	</p>
...
<!--		<h3 class="no-indent"><?php comment_author_link(); ?></h3> -->
                ...
                <div class="span7">
                	<div class="well">
                        <h4 style="margin-bottom:0px;"><span class="colored"><?php comment_author_link(); ?></span> <a style="color:inherit; padding-left:7px;" href="<?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ) ?>"><?php echo get_comment_date('d M Y') ?></a></h4>
                        <div>
                            <?php comment_text() ?>
                        </div>
                    </div>
