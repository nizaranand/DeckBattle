<?php
	// Template Name: Blog Template II
?>
<?php get_header(); ?>
<?php 
	global $more;
                                ...
                                <div class="span8">
                                    <div class="blog_item">
                                        <div class="blog_head">
                                            ...
                                            <span><strong><i class="icon-user icon-white"></i> Author:</strong> <?php the_author_meta('nickname'); ?></span>
                                            <span><strong><i class="icon-list-alt icon-white"></i> Tags:</strong> <?php $tag = get_the_tags(); if (! $tag) { ?> There is no tags<?php } else { ?><?php the_tags(''); ?><?php } ?></span>
                                            <span><strong><i class="icon-comment icon-white"></i> Comments:</strong> <a href="<?php the_permalink() ?>#comments"><?php comments_number('0','1','%')?></a></span>
                                        	<span><strong><i class="icon-user icon-white"></i> Date:</strong> <?php the_time('d M Y') ?></span>
                                        </div>
